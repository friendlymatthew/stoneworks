        ...
        <div className="grid grid-cols-1 ">
          ...
          <div className="grid grid-cols-1 place-items-center">
            <div className="grid sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-2  mt-8 mb-8 gap-0">
              <section
                id="newest"
                className="grid grid-cols-1 place-items-center lg:place-items-end"
              >
                <div className="">
                  <ReactPlayer
                  ...
                  <div className="bg-gradient-to-br from-purple-600 to-indigo-500 rounded-bl-lg px-8 py-4">
                    <span className="">
                      <div className="font-bold text-2xl md:text-4xl">
                        Channel Content
                      </div>
                      <div
                        className="grid grid-cols-3 my-6 gap-8"
                        style={{ width: 720 }}
                      >
                        <div className="group hover:scale-105 transition duration-300 ease-in">
                          ...
                          <div className="text-sm text-primary-content text-opacity-70">
                            helps with world building, is focused on studying
                            real life science, culture, history, as well as
                        ...
                        <div className="group hover:scale-105 transition duration-300 ease-in">
                          ...
                          <div className="text-sm text-primary-content text-opacity-70">
                            ...
                            which shows player’s history of nations, cultures,
                            and religions
                          </div>
                          <button className=" text-accent py-2 hover:underline hover:text-accent-focus rounded-lg">
                            See More
                        ...
                        <div className="group hover:scale-105 transition duration-300 ease-in">
                          ...
                          <div className="text-sm text-primary-content text-opacity-70">
                            my goofing around and being creative with no rhyme
                            or reason, other than to just have fun
                          </div>
                          <button className="text-accent py-2 hover:underline hover:text-accent-focus rounded-lg">
                            See More
                          </button>
